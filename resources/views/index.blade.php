                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        @foreach ($banners as $key => $banner)
                            ...
                            @endif">
                                <div class="col-sm-6">
                                    <h1><span>E</span> - {{ $banner->text1 }}</h1>
                                    <h2>{{ $banner->text2 }}</h2>
                                    <p>{{ $banner->text3 }}</p>
                                    <button type="button" class="btn btn-default get">Get it now</button>
                                </div>
                                <div class="col-sm-6">
                                    <img src="{{ asset('backend/assets/images/banner/'.$banner->image) }}" class="girl img-responsive" alt="" />
                                ...
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="{{ asset("product/$product->id") }}">
                                                <img src="{{ asset('/backend/assets/images/products/small/'.$product->image) }}" alt="" />
                                            </a>
                                            <h2 style="font-size:15px">{{ number_format($product->price, 0) }} - VNĐ</h2>
