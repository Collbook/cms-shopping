    ...
    <div class="main-wrapper">
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center bg-dark">
            <div class="auth-box bg-dark border-top border-secondary">
                <div id="loginform">
                    <div class="text-center p-t-20 p-b-20" style="padding-top: 8px;padding-bottom:8px;">
                        {{-- <span class="db"><img src="{{ asset('backend/assets/images/logo.png') }}" alt="logo" /></span> --}}
                        <h1 style="font-size: 88px;font-family: unset;"><span style="color:#9c4f0c">M</span><span style="color:#5e8fa7;">entoza</span> </h1>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" method="POST" id="loginform" action="{{ route('admin.login') }}">
                        @csrf
