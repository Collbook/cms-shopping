...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form class="form-horizontal" action="{{ route('admin.coupons.update',['id'=>$coupon->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="coupon_code" value="{{ $coupon->coupon_code }}" minlength="5" maxlength="15" class="form-control"  required autofocus placeholder="Coupon here">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="number" min="0" name="amount" value="{{ $coupon->amount }}" class="form-control" required autofocus  placeholder="amount here">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <p><input type="expiry_date" name="expiry_date" value="{{ $coupon->expiry_date }}" id="datepicker" class="form-control"  required autofocus placeholder="Expiry here"></p>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="checkbox" name="status" @if ($coupon->status)
                                    {{ 'checked' }}
